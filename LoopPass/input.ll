...
define dso_local void @loop_example(ptr nocapture noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = icmp sgt i32 %1, 0
...
7:                                                ; preds = %4, %7
  ...
  %13 = icmp eq i64 %12, %5
  br i1 %13, label %6, label %7, !llvm.loop !9
}
...
!4 = !{!"Ubuntu clang version 19.1.1 (1ubuntu1)"}
!5 = !{!6, !6, i64 0}
!6 = !{!"int", !7, i64 0}
